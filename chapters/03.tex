...
sufficient exposure to a given (high \isi{frequency}) category. We will
...
between voiced-\isi{voiceless} minimal pairs like “bad” and “bat”
...
}and /\emph{s}/, among others. Whether considered to be \isi{phonetic} or
