...
from the “unlengthened” (sub) category\footnote{This is implemented as the State Model in \sectref{sec:Models-of-Change}}.
...
will be discussed in more depth in \sectref{sec:Models-of-Change}. 
