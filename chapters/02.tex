...
\includegraphics[width=0.25\textwidth]{figures/8000iterwithentrenchment.pdf}}\hfill{}\subfloat[\label{fig:NoEntrenchment}Without Entrenchment]{\includegraphics[width=0.25\textwidth]{figures/8000iternoentrenchment.pdf}

}\hfill{}\subfloat[\label{fig:No-memory-decay:}Without Memory Decay]{\includegraphics[width=0.25\textwidth]{figures/8000iternomemory.pdf}
...
\includegraphics[width=0.3\textwidth]{figures/FrequencyEffect.pdf}}\hfill{}\subfloat[\label{fig:Freq.EqualTokens}1:1 Token Ratio]{

\includegraphics[width=0.3\textwidth]{figures/FrequencyEffectEqNums.pdf}}\caption{Simulation of Iterative Biasing for H(igh) frequency category versus
...
\begin{raggedright}
\subfloat[1000 iterations]{\includegraphics[width=0.3\textwidth]{figures/1000iter.pdf}

}\hfill{}\subfloat[5000 iterations]{\includegraphics[width=0.3\textwidth]{figures/5000iter.pdf}
