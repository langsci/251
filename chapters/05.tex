...
\begin{figure}[H]
\subfloat[\label{fig:/k+i}/k+i/]{\includegraphics[width=0.4\paperwidth,bb = 0 0 200 100, draft, type=eps]{palatalizationa.pdf}}\hfill{}\subfloat[\label{fig:/k=0002B2+i/} {/kʲ+i/}]{\includegraphics[width=0.4\paperwidth,bb = 0 0 200 100, draft, type=eps]{palatalizationb.pdf}}\caption{Coarticulation involving the same articulator. The dark solid lines
